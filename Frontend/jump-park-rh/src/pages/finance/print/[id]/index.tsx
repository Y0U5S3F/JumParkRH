    ...
    <Box sx={{ p: 12, pb: 6 }}>
      ...
      <Grid container>
        <Grid item xs={8} sm={7} lg={9}>
          <Box sx={{ mb: 2, display: 'flex', alignItems: 'center' }}>
            <Typography variant='body2' sx={{ mr: 2, color: 'text.primary', fontWeight: 600, letterSpacing: '.25px' }}>
              Note:
            </Typography>
...
PreviewCard.getLayout = (page: ReactNode) => <BlankLayout>{page}</BlankLayout>
