...
import { CreateAbsence } from 'src/store/request/absences'
...
const TableHeader = (props: TableHeaderProps) => {
  ...
  const addTypeAbsenceMutation = useMutation(CreateAbsence, {
    onSuccess: () => {
  ...
  const onSubmit = (event: FormEvent<HTMLFormElement>) => {
    ...
    addTypeAbsenceMutation.mutate({ user, reason, title, start_date, end_date, status })
    setOpen(false)
    setTitle('')
    setReason('')
    setStatus('')
