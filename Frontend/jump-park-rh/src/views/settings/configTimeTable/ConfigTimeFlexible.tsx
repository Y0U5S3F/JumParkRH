// ** React Imports
import { Ref, useState, forwardRef, ReactElement, MouseEvent, Fragment, useEffect, SyntheticEvent } from 'react'
...
import { FormControl, Select, Tab, TableCell } from '@mui/material'
              ...
              <TabContext value={value}>
                <TabList onChange={handleChangeTab} aria-label='customized tabs example'>
                  {departments?.map((department: any, index: any) => (
                    <Tab value={department.id} label={department.name} key={index} />
                  ))}
                  {/* <Tab value='2' label='Tab 2' />
                  <Tab value='3' label='Tab 3' /> */}
                </TabList>
                {departments?.map((department: any, index: any) => (
                  <TabPanel value={department.id} key={index}>
                    <Grid container spacing={3} sx={{ mt: 6 }}>
                      ...
                      <Grid item lg={4} md={4} sm={6}>
                        <TextField value='Flexible schedule' placeholder='Enter Name' />
                      </Grid>
                    </Grid>
                                    ...
                                    <TableCell>
                                      {showDatePicker[index] && (
                                        <Box sx={{ display: 'flex', alignItems: 'auto' }}>
                                          ...
                                          <Typography
                                            variant='body1'
                                            sx={{ mr: 4, ml: 4, pt: 3.5, alignItems: 'center' }}
                                          >
                                            pause
                                          </Typography>
                                          ...
                                          <TextField
                                            ...
                                            onChange={event =>
                                              handleChange(day.id, 'break_duration', event.target.value)
                                            }
                                          ></TextField>
