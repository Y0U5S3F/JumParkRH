...
import { CreateTypeAbsence } from 'src/store/settings/configAbsence'
...
const TableHeader = (props: TableHeaderProps) => {
  ...
  const addTypeAbsenceMutation = useMutation(CreateTypeAbsence, {
    onSuccess: () => {
  ...
  const onSubmit = (event: FormEvent<HTMLFormElement>) => {
    ...
    addTypeAbsenceMutation.mutate({ name, color })
    setOpen(false)
    setName('')
    setColor('')
  }
