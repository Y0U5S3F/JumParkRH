...
class Absence(TimeStampedModel):
    ...
    start_date = models.DateField("date début d'absence", null=True, blank=True)
    end_date = models.DateField("date fin d'absence", null=True, blank=True)
    absence_start_time = models.TimeField("Heure debut d'absence", null=True, blank=True)
    absence_end_time = models.TimeField("Heure fin d'absence", null=True, blank=True)
    reason=models.ForeignKey(AbsenceType, blank=True,
